...
async def agent_chat(
    ...
    """Chat with TechJob AI Agent (ReAct Agent powered by GPT-4o).
    The agent can query the database, search jobs semantically,
    predict salaries, look up company culture, and generate charts."""
...
async def generate_cover_letter_endpoint(
    ...
    Uses GPT-4o with anti-hallucination prompting."""
